...
export const Session = ({ serviceData }) => {
  ...
  const creventic = useRef(Creventic.create());
  const [state, dispatch] = useReducer(createMessageHandler(creventic.current), null, createInitialState(serviceData));
